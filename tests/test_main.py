...
class TestReadCSV:
    ...
    def test_returns_none_on_file_not_found(self):
        """Проверяем обработку ошибки FileNotFoundError."""
...
class TestReportStudentsPerformance:
    ...
    def test_calc_avg_for_student(self, csv_for_avg_calc_student):
        """Проверяем правильный подсчет средней оценки одного студента."""
        with patch(
    ...
    def test_calc_avg_for_some_students(self, csv_for_avg_calc_some_students):
        """Проверяем правильный подсчет средней оценки нескольких студентов."""
        with patch(
            "builtins.open",
    ...
    def test_rate_students(self, csv_for_rate_students):
        """Проверяем правильное ранжирование студентов в отчете."""
        with patch(
...
class TestMainModule:
    ...
    def test_main_no_args_files(self, mock_parser):
        """Проверяем обработку ошибки запуска скрипта без аргументов."""
        mock_args = MagicMock()
    ...
    def test_main_no_csv_file(self, mock_parser):
        """Проверяем обработку запуска скрипта с указанием не csv-файла."""
        mock_args = MagicMock()
    ...
    def test_main_wrong_report(self, mock_parser):
        """Проверяем запуск скрипта с неправильным аргументом --report."""
        mock_args = MagicMock()
    ...
    def test_main_right_work(
        ...
        """Проверяем корректное выполнение скрипта с корректными данными."""
        mock_args = MagicMock()
